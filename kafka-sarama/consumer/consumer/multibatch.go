...
type batchMessages []*SessionMessage
...
func NewMultiBatchConsumerGroupHandler(cfg *MultiBatchConsumerConfig) GroupHandler {
...
func (h *multiBatchConsumerGroupHandler) insertMessage(msg *SessionMessage) {
	h.mu.Lock()
	defer h.mu.Unlock()
